...
from app.services.export_hub.buyer_auth_service import BuyerAuthService
from app.services.shared.password_reset_service import PasswordResetService
...
async def admin_me(
    ...
    return AdminMeResponse(
        ...
        role_label=roles[0] if roles else "Export Hub Admin",
    )
