...
from app.models.shared.enums import SenderRole
from app.models.export_hub.misc import BuyerRegistrationDraft, BuyerSavedSupplier
...
async def update_buyer_company_profile(
    ...
    from app.schemas.export_hub.buyer_onboarding import BuyerCompanyStep
...
async def update_buyer_sourcing_profile(
    ...
    from app.schemas.export_hub.buyer_onboarding import BuyerSourcingStep
