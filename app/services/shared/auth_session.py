...
from app.core.shared.security import create_access_token, create_refresh_token, hash_refresh_token
...
async def create_login_session(
    ...
    *,
    ...
    db.add(session)
    access = create_access_token(account_id, account_type, platform=platform)
